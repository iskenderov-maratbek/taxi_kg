...
class PinCodeView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PinCodeView> createState() => _PinCodeDialogState();
}

class _PinCodeDialogState extends ConsumerState<PinCodeView> {
      ...
      child: Column(
        ...
        children: [
          ...
          primaryButton('Подтвердить', onPressed: () {
            ref.read(authServiceProvider).auth(isNumber: false, code: _pinCodeController.text);
          }, vertical: 15),
